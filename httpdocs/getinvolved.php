...
<p>You can view <a href="/">our current listings</a> and <a href="/guide/submit.php">submit a listing</a> that you think we might be missing. Take a look at our <a href="/principles/">principles</a> to get a flavour of what <?php print $guide_name; ?> is here to promote.</p>
...
<p>We meet on an adhoc basis to work on <?php print $guide_name; ?>. We share ideas, proposals and content for the guide and project. Please just <a href="/contact.php">contact us</a> if you're interested in coming along and getting involved.</p>

<h3>Help us with distribution</h3>

<p>We're looking for places in <?php print $city; ?> that'll be happy to stock our printed guide. If you could stock the guide then please <a href="/contact.php">let us know</a>.</p>
